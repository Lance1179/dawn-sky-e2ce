...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/dawn-sky-e2ce#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/dawn-sky-e2ce
```

A live public deployment of this template is available at [https://dawn-sky-e2ce.templates.workers.dev](https://dawn-sky-e2ce.templates.workers.dev)
